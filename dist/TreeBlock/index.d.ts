...
declare const TreeBlock: ({ resources, expandedItems, setExpandedItems, onChange, resourceForbiddenCharsRegex, buttons: Buttons, icons: Icons, components: Components, admin, t, }: TreeBlockProps) => React.JSX.Element;
