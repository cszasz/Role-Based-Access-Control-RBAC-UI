...
var AddRole = function AddRole(_ref) {
  ...
  }, translate('admin_local.ui.addRole', 'Add Role'), " ", React.createElement(AddRoleIcon, {
    fontSize: "small"
  }));
};
...
var CheckboxBlock = function CheckboxBlock(_ref) {
  ...
  return React.createElement(Components.CheckboxTableContainer, null, React.createElement(Dialog, {
    ...
    return React.createElement(StyledCell, {
      key: row
    }, React.createElement(Components.RoleTag, null, t("admin_local.role_names." + row, row)), isReadOnly(row) ? null : React.createElement(RoleActions, null, React.createElement(Icons.EditIcon, {
      fontSize: "small",
      onClick: function onClick() {
