  ...
  return React.createElement(TreeBlockContainer, null, Object.keys(items).map(function (resource) {
    ...
    return React.createElement(StyledTreeItem, {
      ...
      label: React.createElement(TreeItemContent, {
        ...
        "$hasChildren": hasChildren
      }, t("admin_local.resource." + items[resource].name, items[resource].name)), displayDescription ? React.createElement(ItemResource, null, items[resource].description ? React.createElement(React.Fragment, null, t("admin_local.resource." + resource + ".description", items[resource].description), admin && React.createElement("span", {
        style: {
          color: '#888',
          marginLeft: '10px'
        }
