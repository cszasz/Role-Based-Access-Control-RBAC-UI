  ...
  return React__default.createElement(TreeBlockContainer, null, Object.keys(items).map(function (resource) {
    ...
    return React__default.createElement(StyledTreeItem, {
      ...
      label: React__default.createElement(TreeItemContent, {
        ...
        "$hasChildren": hasChildren
      }, t("admin_local.resource." + resource, resource)), displayDescription ? React__default.createElement(ItemResource, null, items[resource].description ? React__default.createElement(React__default.Fragment, null, t("admin_local.resource." + resource + ".description", items[resource].description), admin && React__default.createElement("span", {
        style: {
          color: '#888',
          marginLeft: '10px'
        }
