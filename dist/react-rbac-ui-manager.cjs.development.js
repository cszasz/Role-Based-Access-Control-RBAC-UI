...
var TreeBlock = function TreeBlock(_ref) {
  ...
  }, "Delete")))), React__default.createElement(TreeHeaderContainer, null, React__default.createElement(ResourceTitle, null, "Resource"), React__default.createElement(PermissionTitle, null, "Permission")), React__default.createElement(StyledTreeView, {
    defaultCollapseIcon: React__default.createElement(Icons.TreeCollapseIcon, null),
    defaultExpandIcon: React__default.createElement(Icons.TreeExpandIcon, null),
...
var CheckboxBlock = function CheckboxBlock(_ref) {
  ...
  return React__default.createElement(Components.CheckboxTableContainer, null, React__default.createElement(Dialog, {
    ...
    return React__default.createElement(StyledCell, {
      key: row
    }, React__default.createElement(Components.RoleTag, null, row), React__default.createElement(RoleActions, null, React__default.createElement(Icons.EditIcon, {
      fontSize: "small",
      onClick: function onClick() {
